...
- Settings 支持 **UI Scale 80% / 90% / 100% / 110% / 120%**，会同步缩放面板、控件和文字并写入当前存档
- 按 **F9** 可打开 UI Debug Overlay，查看当前页面、FPS、鼠标坐标、敌人/子弹/粒子数量
...
- 主菜单的 **Hangar** 机库入口可管理装备等级、品质和强化费用
- 击杀敌机和 Boss 会获得 **Credits / Cores / Alloy**；资源、装备等级和战机选择会自动保存到本地
- 装备系统包含主武器、副武器、装甲和僚机四个槽位；点击装备卡即可强化，点击仓库模块即可替换对应槽位
